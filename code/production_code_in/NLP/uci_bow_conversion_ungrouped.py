...
parser = argparse.ArgumentParser(description='Convert tweets into UCI BOW format for BigARTM \n Writes out docword_individual.txt and vocab.txt')
parser.add_argument('--input', type=str, default="/home/vt/extra_storage/Production/output/tweets_top5000_joined_by_rank.json",
                    help='Tweets file in json format, default is /home/vt/extra_storage/Production/output/tweets_top5000_joined_by_rank.json')
parser.add_argument('--output', type=str, default="/home/vt/extra_storage/Production/output/",
                    help='The output folder for docword_individual.txt and vocab.txt')
    
args = parser.parse_args()
input_tweets_folder = args.input
...
#output_path = '/home/vt/extra_storage/Production/output/'
#output_path = './'
...
shutil.copy(saved_file[0] , output_path + 'docword_individual.txt')
